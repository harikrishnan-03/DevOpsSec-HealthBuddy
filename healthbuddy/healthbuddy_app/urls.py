...
urlpatterns = [
    ...
    path('updatemedicineform/<int:id>',views.updateMedicineForm,name="updateMedicineForm"),
    ...
    path('updatevaccineform/<int:id>',views.updateVaccineForm,name="updateVaccineForm"),
    ...
    path('updateinsuranceform/<int:id>',views.updateInsuranceForm,name="updateInsuranceForm"),
    ...
    path('updatelabresultform/<int:id>',views.updateLabResultForm,name="updateLabResultForm"),
    ...
    path('updateallergiesform/<int:id>',views.updateAllergiesForm,name="updateAllergiesForm"),
    path('deleteallergies/<int:id>',views.deleteAllergies,name="deleteAllergies"),

    path('listallergicmedicine',views.listAllergicMedicine,name="listAllergicMedicine"),
    path('addallergicmedicine',views.addAllergicMedicine,name="addAllergicMedicine"),
    path('updateallergicmedicine/<int:id>',views.updateAllergicMedicine,name="updateAllergicMedicine"),
    path('updateallergicmedicineform/<int:id>',views.updateAllergicMedicineForm,name="updateAllergicMedicineForm"),
    path('deleteallergicmedicine/<int:id>',views.deleteAllergicMedicine,name="deleteAllergicMedicine"),
